...
<div>
    ...
    <form wire:submit="login">
        ...
        <div>
            ...
            <x-form.input wire:model="form.email" id="email" class="block mt-1 w-full" type="email" name="email"
        ...
        <div class="mt-4">
            ...
            <x-form.input wire:model="form.password" id="password" class="block mt-1 w-full" type="password"
